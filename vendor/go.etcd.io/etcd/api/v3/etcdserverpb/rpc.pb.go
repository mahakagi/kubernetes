...
type RangeRequest struct {
	...
	// `fast_count` is used to determine if a full key iteration is needed to compute `RangeResponse.count` for a matching prefix.
	FastCount            bool     `protobuf:"varint,99,opt,name=fast_count,json=fastCount,proto3" json:"fast_count,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_77a6da22d6a3feb1 = []byte{
	...
	0x01, 0x4e, 0x0d, 0xcf, 0x3f, 0x66, 0xbd, 0x68, 0xf6, 0x79, 0x97, 0x28, 0x65, 0x8b, 0x12, 0xf0,
	...
	0xfd, 0xdb, 0x00, 0x00, 0x00, 0xff, 0xff, 0x98, 0x1b, 0xe7, 0x5c, 0x0e, 0x3d, 0x00, 0x00,
}
